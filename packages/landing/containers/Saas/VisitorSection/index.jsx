...
import MobileAppMarketing from 'common/src/assets/image/saas/pratik-gupta-CNOo9ZMBqRM-unsplash.jpg';
      ...
      <SectionObject>
        <Card className="objectWrapper" {...imageWrapper}>
          ...
          <Card className="dashboardWrapper" {...imageWrapper}>
            <Fade left>
              <Image src={MobileAppMarketing} alt="Mobile App Marketing" />
            </Fade>
          </Card>
        </Card>
      </SectionObject>
